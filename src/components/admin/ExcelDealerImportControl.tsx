...
export const ExcelDealerImportControl: React.FC = () => {
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(data.error || "خطا در آپلود فایل اکسل نمایندگی‌ها");
      }
    } catch {
  ...
  return (
    ...
    >
      ...
      >
        <a
          href="/api/admin/download-dealer-template"
          download
          style={{
            padding: "8px 16px",
            fontSize: "12px",
        ...
        >
          📥 دانلود قالب اکسل نمایندگی‌ها (FA/EN/AR)
        </a>
        ...
        >
          {loading
            ...
            : "📤 آپلود اکسل و بروزرسانی نمایندگی‌ها"}
          <input
            type="file"
            accept=".xlsx, .csv"
      ...
      {report && (
        ...
        >
          <p style={{ color: "#22c55e", margin: "2px 0" }}>
            ✅ نمایندگی‌های جدید: {report.createdCount} مورد
          </p>
          <p style={{ color: "#3b82f6", margin: "2px 0" }}>
            🔄 نمایندگی‌های بروزرسانی‌شده: {report.updatedCount} مورد
          </p>
